...
! function(e, t) {
    ...
    var e, t, I = function(e, t) {
        ...
        X = {
            ...
            animations: function(e) {
                ...
                return I(t, function(t, e) {
                    var n, r, o, i, a, s, u = (i = (n = e)[r] && "object" === h(n[r][o]) ? n[r][o] : n[r] || n, a = "string" == typeof i ? i : i.type, s = "object" === (void 0 === i ? "undefined" : h(i)) ? Object.assign({}, i) : {}, _[a] ? _[a](s) : null);
        ...
        _e = {
            ...
            labelIdle: ['<span class="filepond--label-action">Browse</span>', le.STRING],
            ...
            var r = {
                ...
                o = function(t) {
                    e ? (r.timestamp = Date.now(), r.request = e(t, function(e) {
                        ...
                        i.fire("meta", {
                            size: r.size,
                            filename: Le("string" == typeof e ? e : e.headers)
                        })
                    })) : i.fire("error", {
                        type: "error",
                        body: "Can't load URL",
        ...
        Ge = function() {
            ...
            return function(r, o, t, e, n, i) {
                var a = we(r, s + u.url, Object.assign({}, u, {
                    responseType: "blob"
                }));
        ...
        Qe = function(s, u) {
            return function() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    a = ve(s.items, t);
                a ? u(a, r, i) : i({
                    error: Ce("error", 0, "Item not found"),
                    file: null
                })
            }
        },
            ...
            return {
                ...
                DID_UPDATE_ITEM_METADATA: function(e) {
                    ...
                    if (R("IS_ASYNC")) {
                        ...
                        return n.status === Ve.PROCESSING_COMPLETE ? (r = O.options.instantUpload, void n.revert(Ue(O.options.server.url, O.options.server.revert)).then(r ? i : function() {})) : n.status === Ve.PROCESSING ? (o = O.options.instantUpload, void n.abortProcessing().then(o ? i : function() {})) : void(O.options.instantUpload && i())
                    }
                ...
                ADD_ITEM: function(e) {
                    ...
                    if (w(n)) s({
                        ...
                        if (! function(e) {
                            ...
                            var f = me(O.items)[0];
                            f.status === Ve.PROCESSING_COMPLETE && f.revert(Ue(O.options.server.url, O.options.server.revert)), h("REMOVE_ITEM", {
                                query: f.id
                            })
                        }
                        ...
                        d.on("load-init", function() {
                            ...
                            h("DID_THROW_ITEM_PROCESSING_ERROR", {
                                ...
                                error: e,
                                status: {
                                    main: ze(O.options.labelFileProcessingError)(e),
                                    sub: O.options.labelTapToRetry
                                }
                            })
                ...
                COMPLETE_LOAD_ITEM: function(e) {
                    ...
                    }), r(ae(t)), t.origin !== xe.LOCAL ? t.origin !== xe.LIMBO ? R("IS_ASYNC") && O.options.instantUpload && h("REQUEST_ITEM_PROCESSING", {
                        query: t.id
                    }) : h("DID_COMPLETE_ITEM_PROCESSING", {
                        id: t.id,
                        error: null,
                ...
                REQUEST_ITEM_PROCESSING: Qe(O, function(e, t, n) {
                    var r = e.id;
                    e.status !== Ve.PROCESSING_QUEUED && (e.requestProcessing(), h("DID_REQUEST_ITEM_PROCESSING", {
                        id: r
                    }), h("PROCESS_ITEM", {
                        query: e,
                        success: t,
                ...
                REVERT_ITEM_PROCESSING: Qe(O, function(e) {
                    e.revert(Ue(O.options.server.url, O.options.server.revert)).then(function() {
                        (O.options.instantUpload || !We(e.file)) && h("REMOVE_ITEM", {
                            query: e.id
                        })
                    })
                }),
    ...
    var gt, It = function(e) {
        ...
        Pt = a({
            create: function(e) {
                var r = e.root,
                    ...
                    i = r.query("IS_ASYNC"),
                    a = i ? mt.concat() : mt.filter(function(e) {
                ...
                }), r.ref.info = r.appendChildView(r.createChildView(ft, {
                    id: o
                })), r.ref.status = r.appendChildView(r.createChildView(vt, {
                    id: o
                })), r.ref.processingCompleteIndicator = r.appendChildView(r.createChildView(bt)), r.ref.processingCompleteIndicator.element.dataset.align = r.query("GET_STYLE_BUTTON_PROCESS_ITEM_POSITION");
                var u = r.appendChildView(r.createChildView(nt, {
                    opacity: 0
                }));
                ...
                var l = r.appendChildView(r.createChildView(nt, {
                    opacity: 0
                }));
        ...
        Lt = a({
            create: function(e) {
                var t = e.root,
                    n = e.props;
                t.ref.fileName = Je("legend"), t.appendChild(t.ref.fileName), t.ref.file = t.appendChildView(t.createChildView(Pt, {
                    id: n.id
                }));
                var r = Je("input");
        ...
        Gt = a({
            create: function(e) {
                var t = e.root,
                    n = e.props;
                t.ref.controls = t.appendChildView(t.createChildView(Lt, {
                    id: n.id
                })), t.ref.panel = t.appendChildView(t.createChildView(Ct, {
                    name: "item-panel"
        ...
        Ut = s({
            DID_ADD_ITEM: function(e) {
                ...
                i === K && (a.translateY = null), i === $ && (a.scaleX = .8, a.scaleY = .8, a.translateY = null), i === Z && (a.translateY = -30), i === Q && (a.translateX = -100, a.translateY = null), t.appendChildView(t.createChildView(Gt, Object.assign({
                    id: r
                }, a)), o)
            },
            DID_REMOVE_ITEM: function(e) {
        ...
        Qt = s({
            DID_DRAG: function(e) {
                ...
                if (!o.ref.blob) return t = {
                    root: o
                }.root, n = .5 * t.rect.element.width, r = .5 * t.rect.element.height, void(t.ref.blob = t.appendChildView(t.createChildView(kt, {
                    opacity: 0,
                    scaleX: 2.5,
                    scaleY: 2.5,
                    translateX: n,
                    ...
                    t.some(function(e) {
                        ...
                        if (s)
                            if (dn(c, n)) {
                                ...
                                i(cn(c))
                            } else t && !l && _n(f, "none"), e.state && (e.state = null, o(cn(c)));
                        else _n(f, "none")
                    })
                })
            }
        ...
        Vn = a({
            ...
            create: function(e) {
                ...
                }))), r.ref.list = r.appendChildView(r.createChildView(Vt, {
                    translateY: null
                })), r.ref.panel = r.appendChildView(r.createChildView(Ct, {
                    name: "panel-root"
                })), r.ref.assistant = r.appendChildView(r.createChildView(Cn, Object.assign({}, t))), r.ref.measure = Je("div"), r.ref.measure.style.height = "100%", r.element.appendChild(r.ref.measure), r.ref.bounds = null, r.query("GET_STYLES").filter(function(e) {
                    return !w(e.value)
                }).map(function(e) {
                    var t = e.name,
                        n = e.value;
                ...
                g = Object.assign({}, re(), f, (a = i, s = {}, I(o, function(t) {
                    ...
                    addFiles: function() {
                        ...
                        return new Promise(function(t, e) {
                            var n = [],
                                r = {};
                            if (S(s[0])) n.push.apply(n, R(s[0])), Object.assign(r, s[1] || {});
                            else {
                                var o = s[s.length - 1];
    ...
    n.supported = or, Object.defineProperty(n, "__esModule", {
        value: !0
    })
});